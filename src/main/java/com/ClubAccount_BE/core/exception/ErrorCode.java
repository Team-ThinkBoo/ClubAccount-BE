...
public enum ErrorCode {
    ...
    DATABASE_EXCEPTION("0009", "데이터베이스 에러입니다.", HttpStatus.INTERNAL_SERVER_ERROR),

    // 인증 관련 에러 코드
    AUTH_FAIL_FORBIDDEN("1001", "접근 권한이 없습니다.", HttpStatus.FORBIDDEN),
    AUTH_FAIL_UNAUTHORIZED("1002", "인증되지 않은 사용자입니다.", HttpStatus.UNAUTHORIZED),
